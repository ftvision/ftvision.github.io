...
module.exports = {
  ...
  plugins: [
    ...
    plugin(function({ addUtilities }) {
      addUtilities({
        // Display - Hero headlines, feature titles
        '.type-display': {
        ...
        // H1 - Article headlines, section titles
        '.type-h1': {
        ...
        // H2 - Section headers within articles
        '.type-h2': {
        ...
        // H4 - Minor headers, list group titles
        '.type-h4': {
        ...
        // Body Small - Secondary content, sidebar text
        '.type-body-sm': {
        ...
        // Caption - Image captions, footnotes, metadata
        '.type-caption': {
        ...
        // Label - Form labels, UI text, buttons
        '.type-label': {
        ...
        // Overline - Category tags, section markers
        '.type-overline': {
