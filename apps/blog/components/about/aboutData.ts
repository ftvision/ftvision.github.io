  ...
  en: [
    {
      ...
      description: [
        "Designed, implemented, and maintained the company's CI/CD pipeline, build system, and developer tooling, enabling daily large-scale simulations with 1,000+ AI agents in Minecraft.",
        'Designed and deployed robust cloud infrastructure supporting both user-facing service layers and research-focused evaluation environments.',
        'Led the end-to-end development of a desktop application, Fairies, that empowers computer-use agents to interact seamlessly across 50+ productivity and creative applications. https://fairies.ai/',
      ],
    },
    {
      ...
      description: [
        'Developed a new distributed trading system in Python for all commodities derivatives from scratch.',
        'Founding engineer of the structured power trading desk.',
        'Productionized quant pricing models for structured trades, supporting business growth and customization.',
        'Defined and implemented tools, dashboards, and monitoring systems, automating workflows for middle office, core tech, desk tech, traders, and quants.',
      ],
    },
    {
      ...
      dateRange: '07/2018 - 05/2021',
      description: [
        'Develop, test, and release infrastructure tools for google-wide spelling correction and query understanding services.',
        'Design and develop the backend dependency registry for the entire search stack to improve reliability.',
        'Improve and rewrite the integration testing tool for the query understanding service.',
        'Debug production issues and communicate with other teams to improve search results.',
      ],
    },
    {
      title: 'Python Quantitative Trader Intern',
      organization: 'Akuna Capital',
      location: 'Chicago, IL',
      dateRange: '06/2017 - 08/2017',
      description: [
        'Analyzed options and futures data, researching strategies for volatility term structure trading.',
        'Visualized portfolio risks for S&P desks, enabling intuitive risk assessment for traders.',
      ],
    },
    {
      title: 'C++ Software Engineer Intern (AI Developer)',
      organization: 'Sparkypants Studio (Game: Dropzone)',
      location: 'Baltimore, MD',
      dateRange: '05/2016 - 08/2016',
      description: [
        'Built an AI broadcasting system to create new, human-like game-watching experiences.',
        'Automated scene and map creation pipelines, streamlining collaboration between art, UI, and dev.',
      ],
    },
  ],
  zh: [
    {
      ...
      description: [
        '设计、实现并维护公司的CI/CD流水线、构建系统和开发者工具，支持每日1000+AI代理在Minecraft中的大规模模拟。',
        '设计并部署稳健的云基础设施，支持面向用户的服务层和研究导向的评估环境。',
        '主导桌面应用Fairies的端到端开发，使计算机代理能够无缝交互50+生产力和创意应用。https://fairies.ai/',
      ],
    },
    {
      ...
      dateRange: '06/2021 - 03/2024',
      description: [
        '从零开始用Python开发了一个新的分布式交易系统，用于所有大宗商品衍生品。',
        '结构化电力交易台的创始工程师。',
        '将量化定价模型产品化用于结构化交易，支持业务增长和定制化。',
        '定义并实现工具、仪表板和监控系统，为中台、核心技术、交易台技术、交易员和量化分析师自动化工作流程。',
      ],
    },
    {
      title: '高级软件工程师',
      ...
      dateRange: '07/2018 - 05/2021',
      description: [
        '开发、测试和发布全Google范围内拼写纠正和查询理解服务的基础设施工具。',
        '设计和开发整个搜索栈的后端依赖注册表以提高可靠性。',
        '改进和重写查询理解服务的集成测试工具。',
        '调试生产问题并与其他团队沟通以改善搜索结果。',
      ],
    },
    {
      title: 'Python量化交易实习生',
      ...
      dateRange: '06/2017 - 08/2017',
      description: [
        '分析期权和期货数据，研究波动率期限结构交易策略。',
        '为S&P交易台可视化投资组合风险，使交易员能够直观评估风险。',
      ],
    },
    {
      title: 'C++软件工程师实习生（AI开发者）',
      organization: 'Sparkypants Studio (游戏: Dropzone)',
      location: 'Baltimore, MD',
      dateRange: '05/2016 - 08/2016',
      description: [
        '构建AI广播系统，创造新的、类人的游戏观看体验。',
        '自动化场景和地图创建流程，简化艺术、UI和开发之间的协作。',
      ],
    },
  ],
};
...
export const education = {
  en: [
    ...
    {
      title: 'B.S. Experimental Psychology',
      organization: 'Peking University',
      location: 'Beijing, China',
      dateRange: '09/2008 - 07/2012',
    },
  ],
  zh: [
    {
...
export const failedJobs = {
  en: [
    ...
    },
    {
      ...
      year: '2026',
      result: 'Rejected after first-round system design interview',
    },
    {
      company: 'Optiver',
      location: 'Shanghai, China',
      role: 'Machine Learning Engineer, AI Lab',
      year: '2026',
      result: 'Rejected after first-round system design interview',
    },
    {
    ...
    },
    {
      ...
      year: '2026',
      result: 'Rejected after first round',
    },
    {
      company: 'Jane Street',
      location: 'New York, NY, U.S.A.',
    ...
    },
    {
      ...
      year: '2026',
      result: 'Rejected at resume screening',
    },
    {
    ...
    {
      company: 'Lobster Computing',
      location: 'San Francisco, CA, U.S.A.',
      role: 'Founding Engineer',
      year: '2026',
      result: 'Rejected by recruiter who felt I was not the product-building person they needed',
    },
    {
      company: 'DRW',
    ...
    },
    {
      ...
      role: 'Member of Technical Staff',
      year: '2024',
      result: 'Rejected after online coding assessment',
    },
    {
      company: 'The D.E.Shaw Group',
      location: 'New York, NY, U.S.A.',
      role: 'Software Developer',
      year: '2023',
      result: 'Rejected after hiring manager round',
    },
    {
