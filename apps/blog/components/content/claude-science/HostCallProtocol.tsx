...
export function HostCallProtocol() {
  return (
    <FigureScaffold
      ...
      caption="The kernel holds no authority of its own; it asks and waits. The daemon answers with the same id and either a data payload or an error. A mismatched reply is discarded, but the wait is bounded: after eight unmatched reads, the SDK raises a protocol-desynchronization error."
    >
        ...
        >
          ...
          <g>
            ...
            <text
              ...
              fontSize="11"
            >
              Mismatched replies are discarded; eight unmatched reads raise a
              protocol-desynchronization error.
            </text>
          </g>
        </svg>
      </div>
